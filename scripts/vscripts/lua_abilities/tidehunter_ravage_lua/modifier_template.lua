...
function modifier_template:RemoveOnDeath()
	return true
end

function modifier_template:DestroyOnExpire()
	return true
end

function modifier_template:AllowIllusionDuplicate()
	return false
end
...
--------------------------------------------------------------------------------
-- Transmitter data
function modifier_template:AddCustomTransmitterData()
	-- on server
	local data = {
		value = self.value
	}
...
function modifier_template:HandleCustomTransmitterData( data )
	-- on client
