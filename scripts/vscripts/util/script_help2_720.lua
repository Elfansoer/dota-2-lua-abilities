...
---[[ CBaseAnimating:SetSkin  Set skin (int). ])
-- @return void
-- @param iSkin int
function CBaseAnimating:SetSkin( iSkin ) end
...
---[[ CDOTA_BaseNPC:GetManaRegenMultiplier  Returns mana regen rate per intelligence. ])
-- @return float
function CDOTA_BaseNPC:GetManaRegenMultiplier(  ) end
...
---[[ CDOTA_BaseNPC_Hero:GetManaRegenMultiplier  Returns the intelligenced based mana regen multiplier. ])
-- @return float
function CDOTA_BaseNPC_Hero:GetManaRegenMultiplier(  ) end
