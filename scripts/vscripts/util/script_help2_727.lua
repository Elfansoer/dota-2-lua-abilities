return [[---[[ AddFOWViewer  Add temporary vision for a given team ( nTeamID, vLocation, flRadius, flDuration, bObstructedVision) ])
-- @return void
-- @param int_1 int
...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 169 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 166 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 167 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 165 -- OnAbilityStart
MODIFIER_EVENT_ON_ATTACK = 158 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 178 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 161 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 223 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 160 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 213 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 159 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 156 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 220 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 157 -- OnAttackStart
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 168 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 190 -- OnBuildingKilled
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 177 -- OnDamageCalculated
MODIFIER_EVENT_ON_DEATH = 179 -- OnDeath
MODIFIER_EVENT_ON_DEATH_PREVENTED = 173 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 210 -- OnDominated
MODIFIER_EVENT_ON_HEALTH_GAINED = 185 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 189 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 188 -- OnHeroKilled
MODIFIER_EVENT_ON_MANA_GAINED = 186 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 191 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 192 -- OnModifierAdded
MODIFIER_EVENT_ON_ORB_EFFECT = 175 -- Unused
MODIFIER_EVENT_ON_ORDER = 163 -- OnOrder
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 176 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 170 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 162 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 221 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 171 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 180 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 184 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 155 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_MANA = 181 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 174 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 172 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 187 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TELEPORTED = 183 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 182 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 164 -- OnUnitMoved
MODIFIER_FUNCTION_INVALID = 255
MODIFIER_FUNCTION_LAST = 226
MODIFIER_PROPERTY_ABILITY_LAYOUT = 209 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 136 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 135 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 137 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 125 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 146 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 147 -- GetAllowEtherealAttack
...
MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 96 -- GetModifierAttackRangeOverride
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 97 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 99 -- GetModifierAttackRangeBonusPercentage
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 98 -- GetModifierAttackRangeBonusUnique
MODIFIER_PROPERTY_AVOID_DAMAGE = 59 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_SPELL = 60 -- GetModifierAvoidSpell
MODIFIER_PROPERTY_BASEATTACK_BONUSDAMAGE = 4 -- GetModifierBaseAttack_BonusDamage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE = 48 -- GetModifierBaseDamageOutgoing_Percentage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 49 -- GetModifierBaseDamageOutgoing_PercentageUnique
...
MODIFIER_PROPERTY_BASE_MANA_REGEN = 73 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BONUS_DAY_VISION = 128 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 129 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 130 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 131 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 225 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 150 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 151 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 215 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 110 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 93 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 95 -- GetModifierCastRangeBonusStacking
MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 94 -- GetModifierCastRangeBonusTarget
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 206 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 108 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 109 -- GetModifierPercentageCooldownOngoing
...
MODIFIER_PROPERTY_DEATHGOLDCOST = 113 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 127 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 145 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 204 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 153 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 218 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 54 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 114 -- GetModifierPercentageExpRateBoost
MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 83 -- GetModifierExtraHealthBonus
MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 85 -- GetModifierExtraHealthPercentage
MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 84 -- GetModifierExtraManaBonus
MODIFIER_PROPERTY_EXTRA_MANA_PERCENTAGE = 86 -- GetModifierExtraManaPercentage
MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 82 -- GetModifierExtraStrengthBonus
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 29 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 132 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 133 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 203 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_HEALTH_BONUS = 80 -- GetModifierHealthBonus
MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 77 -- GetModifierConstantHealthRegen
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 78 -- GetModifierHealthRegenPercentage
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE_UNIQUE = 79 -- GetModifierHealthRegenPercentageUnique
...
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 205 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 214 -- GetModifierIgnoreCooldown
MODIFIER_PROPERTY_IGNORE_MOVESPEED_LIMIT = 26 -- GetModifierIgnoreMovespeedLimit
MODIFIER_PROPERTY_IGNORE_PHYSICAL_ARMOR = 67 -- GetModifierIgnorePhysicalArmor
MODIFIER_PROPERTY_ILLUSION_LABEL = 139 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 217
MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 50 -- GetModifierIncomingDamage_Percentage
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 52 -- GetModifierIncomingPhysicalDamageConstant
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 51 -- GetModifierIncomingPhysicalDamage_Percentage
MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 53 -- GetModifierIncomingSpellDamageConstant
...
MODIFIER_PROPERTY_IS_ILLUSION = 138 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 196 -- GetModifierScepter
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 45 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 200 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 117 -- GetModifierMagical_ConstantBlock
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BASE_REDUCTION = 68 -- GetModifierMagicalResistanceBaseReduction
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 70 -- GetModifierMagicalResistanceBonus
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_ILLUSIONS = 71 -- GetModifierMagicalResistanceBonusIllusions
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 72 -- GetModifierMagicalResistanceDecrepifyUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DIRECT_MODIFICATION = 69 -- GetModifierMagicalResistanceDirectModification
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 111 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 112 -- GetModifierPercentageManacostStacking
MODIFIER_PROPERTY_MANACOST_REDUCTION_CONSTANT = 32 -- GetModifierManacostReduction_Constant
MODIFIER_PROPERTY_MANA_BONUS = 81 -- GetModifierManaBonus
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 74 -- GetModifierConstantManaRegen
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 75 -- GetModifierConstantManaRegenUnique
MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 76 -- GetModifierTotalPercentageManaRegen
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 100 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MIN_HEALTH = 134 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 61 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 194 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 195 -- GetModifierModelScale
...
MODIFIER_PROPERTY_MP_REGEN_AMPLIFY_PERCENTAGE = 46 -- GetModifierMPRegenAmplify_Percentage
MODIFIER_PROPERTY_MP_RESTORE_AMPLIFY_PERCENTAGE = 47 -- GetModifierMPRestoreAmplify_Percentage
MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 55 -- GetModifierNegativeEvasion_Constant
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 207 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 208 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 122 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 124 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 123 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 9 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 148 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 13 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BASE_PERCENTAGE = 62 -- GetModifierPhysicalArmorBase_Percentage
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 64 -- GetModifierPhysicalArmorBonus
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 65 -- GetModifierPhysicalArmorBonusUnique
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 66 -- GetModifierPhysicalArmorBonusUniqueActive
MODIFIER_PROPERTY_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 63 -- GetModifierPhysicalArmorTotal_Percentage
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 118 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 119 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 115 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 116 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 212 -- PreserveParticlesOnModelChanged
...
MODIFIER_PROPERTY_PROJECTILE_NAME = 103 -- GetModifierProjectileName
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 101 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 102 -- GetModifierProjectileSpeedBonusPercentage
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 201 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 197 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REFLECT_SPELL = 126 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 104 -- ReincarnateTime
MODIFIER_PROPERTY_RESPAWNTIME = 105 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 106 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 107 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 202 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 88 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 91 -- GetModifierBonusStats_Agility_Percentage
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 89 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 92 -- GetModifierBonusStats_Intellect_Percentage
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 87 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 90 -- GetModifierBonusStats_Strength_Percentage
MODIFIER_PROPERTY_STATUS_RESISTANCE = 56 -- GetModifierStatusResistance
MODIFIER_PROPERTY_STATUS_RESISTANCE_CASTER = 58 -- GetModifierStatusResistanceCaster
MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING = 57 -- GetModifierStatusResistanceStacking
MODIFIER_PROPERTY_STRONG_ILLUSION = 140 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 141 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 142 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 224 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 222 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 211 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TOOLTIP = 193 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 219 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 39 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 121 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 120 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 198 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 199 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 154 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 144 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 143 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 152 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 149 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 216 -- GetVisualZDelta
